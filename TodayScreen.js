...
export default function TodayScreen({ navigation }) {
  ...
  const todayTasks = tasks.filter(task => {
    ...
    return task.date === today && !task.completed; // Filtra apenas as tarefas não concluídas de hoje
  });
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            completeTask(taskId);
            navigation.navigate('CompletedTasks'); // Navega para a tela de tarefas concluídas
          },
        },
      ],
      { cancelable: false }
